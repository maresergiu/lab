        ...
        var heroObj = {
            ...
            data: {
                initCarouselObj: {
                    ...
                    controls: {
                        step: true,					// next or previous slide controls
            ...
            presentation: {
                genCarousel: () => heroObj.cache.heroMod.find('.mod-carousel').modCarousel(heroObj.data.initCarouselObj)
            },
            init: () => heroObj.presentation.genCarousel()
        };
