lab.helpers = {
    ...
    toggleLoader: function () {
        var $loader = temp.cache.$main.find('.loader-mod');
    ...
    isContentScrolable: function () {
        temp.cache.$html.removeClass('sp');
    ...
    animateElemInView: function () {
        ...
        $animElem.each(function () {
            ...
            if (elemIsInView && $thisAnimElem.data('sync')) {
                parentDelay = elemIsInView && (temp.cache.$window.width() > temp.config.breakpoints.SMALL_WIDTH) ? $thisAnimElem.data('delay') : 300;
